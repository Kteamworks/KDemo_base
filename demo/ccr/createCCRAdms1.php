...
//while ($row = sqlFetchArray($result)) {
	...
	$e_Clinical = $ccr->createElement('Clinicals');
	...
	$e_Clinical->appendChild($e_DateTime);	
	...
	$e_Clinical->appendChild($e_DateTime1);
	...
	$e_Clinical->appendChild(sourceType($ccr, $sourceID));
	
	$e_Agent = $ccr->createElement('Agent');
	$e_Clinical->appendChild($e_Agent);
	...
	$e_Clinical->appendChild($e_Reaction);
