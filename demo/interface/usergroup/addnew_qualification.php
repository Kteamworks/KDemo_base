...
<form name='new_qualification' method='post' action="addnew_qualification.php" onsubmit='return top.restoreSession()'>
...
<tr>
  <td>
   <span class='bold'><?php xl('Qualification','e');?>: </span>
  </td>
  <td></td>
  <td>
 ...
 <tr>
  <td colspan='2'>
   &nbsp;<br>
   <input type='submit' name='submit' id='submit' value=<?php xl('Create New Qualification','e'); ?> />
  </td>
  <td>
  </td>
 </tr>
