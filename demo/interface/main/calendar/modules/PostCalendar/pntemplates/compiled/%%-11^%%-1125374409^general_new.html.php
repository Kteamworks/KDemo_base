<?php /* Smarty version 2.6.2, created on 2017-06-07 12:12:08
...
smarty_core_load_plugins(array('plugins' => array(array('function', 'xl', 'C:\xampp\htdocs\KDemo_base\demo\interface\forms\ros/templates/ros/general_new.html', 589, false),array('function', 'html_radios', 'C:\xampp\htdocs\KDemo_base\demo\interface\forms\ros/templates/ros/general_new.html', 602, false),)), $this); ?>
<html>
<head>
...
"><i class="fa fa-note" style="margin-right: 8px;"></i>Prescription</a></li>
			<li id="plan"><a href="<?php echo $this->_tpl_vars['plan_LINK']; ?>
"><i class="fa fa-note" style="margin-right: 8px;"></i>Plan</a></li>
			<li id="referral"><a href="<?php echo $this->_tpl_vars['referral_LINK']; ?>
"><i class="fa fa-note" style="margin-right: 8px;"></i>Referal</a></li>
			<li id="admission"><a href="<?php echo $this->_tpl_vars['admission_LINK']; ?>
"><i class="fa fa-note" style="margin-right: 8px;"></i>Admission</a></li>
			<li id="summary" ><a href="<?php echo $this->_tpl_vars['summary_LINK']; ?>
">Summary</a></li>
		</ol>
	</nav>
</section>
...
" class="css_button_small" style='padding: 4px 10px 0px 10px;' onclick="top.restoreSession()"><?php  xl("BACK","e");  ?></a> 
