<?php /* Smarty version 2.6.2, created on 2018-08-01 11:42:08
         compiled from C:/xampp/htdocs/demo_test/templates/prescription/general_edit.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'xl', 'C:/xampp/htdocs/demo_test/templates/prescription/general_edit.html', 287, false),array('function', 'amcCollect', 'C:/xampp/htdocs/demo_test/templates/prescription/general_edit.html', 315, false),array('function', 'html_select_date', 'C:/xampp/htdocs/demo_test/templates/prescription/general_edit.html', 336, false),array('function', 'html_options', 'C:/xampp/htdocs/demo_test/templates/prescription/general_edit.html', 342, false),array('function', 'html_radios', 'C:/xampp/htdocs/demo_test/templates/prescription/general_edit.html', 429, false),)), $this); ?>
<html>
<head>
...
/interface/patient_file/encounter/view_form.php?formname=newpatient&id=<?php  echo $nvid2;  ?>">Visit Notes</a></li>
			...
			<li><a href="<?php echo $this->_tpl_vars['WEBROOT']; ?>
/interface/patient_file/history/gyanic_form.php"><i class="fa fa-note" style="margin-right: 8px;"></i>Obstetric History</a></li>
		    <li><a href="<?php echo $this->_tpl_vars['WEBROOT']; ?>
/interface/patient_file/history/prev_preg.php"><i class="fa fa-note" style="margin-right: 8px;"></i>Past History</a></li>
			<li><a href="<?php echo $this->_tpl_vars['WEBROOT']; ?>
/interface/patient_file/history/family_history.php"><i class="fa fa-note" style="margin-right: 8px;"></i>Family History</a></li>
			<li><a href="<?php echo $this->_tpl_vars['WEBROOT']; ?>
/interface/patient_file/history/obstetric_examination.php"><i class="fa fa-note" style="margin-right: 8px;"></i>Obstetric Examination</a></li>
			  <?php  } ?>
