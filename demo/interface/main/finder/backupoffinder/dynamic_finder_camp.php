...
$res = sqlStatement("SELECT option_id, title FROM list_options WHERE " .
  "list_id = 'Patient_List_Camp' ORDER BY seq, title");
...
$(document).ready(function() {
 ...
 var oTable = $('#pt_table').dataTable( {
  ...
  "bServerSide": true,
  "sAjaxSource": "dynamic_finder_camp_ajax.php",
...
<?php if ($GLOBALS['concurrent_layout']) { ?>
   //document.location.href = "../../patient_file/summary/demographics_camp.php?set_pid=" + newpid;
<?php } else { ?>
