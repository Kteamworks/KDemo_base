...
$(document).ready(function() {
 ...
 var oTable = $('#pt_table').dataTable( {
  ...
  "bServerSide": true,
  "sAjaxSource": "dynamic_finder_ajax_opd.php",
...
//document.location.href = "../../patient_file/summary/demographics.php?set_pid=" + newpid;
 document.location.href = "../../forms/fee_sheet_ph/other_medSale.php?set_pid=" + id; 
<?php } else { ?>
   top.location.href = "../../patient_file/patient_file.php?set_pid=" + newpid;
<?php } ?>
  }
 ...
 $(document).ready(function() {
    $('ul.menu1 li').live("click", function() {
		...
		{
		top.restoreSession();
		document.location.href= "../../main/calendar/add_edit_event.php?set_pid=" + newpid;
		}else
		if(name=="New Visit")
		{
		top.restoreSession();
