...
//
if($row2["newcrop_user_role"]=="erxcash")
{
...
{
$query ="SELECT $sellist FROM form_encounter a,patient_data b where a.pid=b.pid and a.date='".$today."' order by $orderby, encounter desc  $limit";
}
else 
{
$query = "SELECT $sellist FROM patient_data a,form_encounter b where a.pid=b.pid and b.date='".$today."' order by $orderby,out_time asc  $limit";
}
