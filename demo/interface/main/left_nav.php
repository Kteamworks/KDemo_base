 ...
 */
 ...
 $primary_docs = array(
  ...
  'dem' => array(xl('Patient')   , 1,  "patient_file/summary/demographics.php"),
   'op' => array(xl('OPD CARD')   , 1,  "patient_file/opprint.php"),
  ...
  'pb' => array(xl('Print Bills'),0,'reports/multiple_bills.php'),
...
$future_app = $appointments['future'];
   ...
   echo "return loadFrame2('$id','$frame','" .
    ...
    elseif($id == 'pfb0')  {
	  echo "return loadFrame2('$id','$frame','" .
        $primary_docs[$name][2] . "')\"><i class='fa fa-tree' aria-hidden='true'></i>
" . $title . ($name == 'msg' ? ' <span id="reminderCountSpan" class="bold"></span>' : '')."<span class='pull-right-container'>
	  ...
	  echo "return loadFrame2('$id','$frame','" .
        ...
        elseif($id == 'ddb0')  {
	  echo "return loadFrame2('$id','$frame','" .
        $primary_docs[$name][2] . "')\"><i class='fa fa-dashboard'></i>" . $title . ($name == 'msg' ? ' <span id="reminderCountSpan" class="bold"></span>' : '')."</a></li>";
 
  }
  
          elseif($id == 'ana0')  {
	  echo "return loadFrame2('$id','$frame','" .
        $primary_docs[$name][2] . "')\"><i class='fa fa-cogs'></i>" . $title . ($name == 'msg' ? ' <span id="reminderCountSpan" class="bold"></span>' : '')."</a></li>";
 
  }
  else {
	  echo "return loadFrame2('$id','$frame','" .
        $primary_docs[$name][2] . "')\"><i class='fa fa-circle-o' aria-hidden='true'></i>
" . $title . ($name == 'msg' ? ' <span id="reminderCountSpan" class="bold"></span>' : '')."</a></li>";
...
?>
    ...
    <ul>
      ...
      <li><a class="collapsed_lv2"><span><?php xl('Patient','e') ?></span></a>
        <ul>
          ...
          <?php genPopLink(xl('Prescriptions'),'prescriptions_report.php'); ?>
  ...
  <li class="active treeview"><a href="#">
            <i class="fa fa-dashboard"></i><span><?php xl('Miscellaneous','e') ?></span> <span class="pull-right-container">
...
<span><?php xl('Patient','e') ?></span><span class="pull-right-container">
    ...
    <ul class="treeview-menu">
	  ...
	  <?php genMiscLink('RTop','fin','0',xl('IN Patient'),'main/finder/p_dynamic_finder_ip.php'); ?>
	   <?php genMiscLink('RTop','fin','0',xl('OT Patient'),'main/finder/p_dynamic_finder_ot.php'); ?>
	  <?php if($newcrop_user_role['newcrop_user_role']=='erxdoctor'|| $newcrop_user_role['newcrop_user_role']=='erxnurse') {?>
...
?>
      ...
      <li class="treeview" ><a href='#'><span><?php echo xlt('Import') ?></span></a>
        <ul class="treeview-menu">
...
<?php }?>
  ...
  ?>
  <li class="treeview"><a href="#" ><i class="fa fa-bed" aria-hidden="true"></i>
<span><?php xl('Bed Management','e') ?></span><span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span></a>
    <ul class="treeview-menu">
...
<?php }?>
	  <?php if (acl_check('admin', 'super')||$newcrop_user_role['newcrop_user_role']=='erxcash'){?>
	   <li class="treeview">
<a href="#" ><i class="fa fa-certificate" aria-hidden="true"></i><span><?php xl('Certificates','e') ?></span><span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span></a>
    <ul class="treeview-menu">
	 ...
	 <?php genMiscLink('RTop','rop','2',xl('Dealth Certificate'), 'reports/dealth_certificate.php'); ?>
	  ...
	  <?php
		...
		<li class="treeview"><a href="#"><i class="fa fa-tasks" aria-hidden="true"></i>
 <span><?php xl('Manage','e') ?></span><span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span></a>
        <ul class="treeview-menu">
		...
		<?php genMiscLink('RTop','rop','0',xl('Telemedicine'), 'reports/telemed.html'); ?>
  ...
  <?php // TajEmo Work by CB 2012/06/21 10:41:15 AM hides fees if disabled in globals ?>
  <?php if(!isset($GLOBALS['enable_fees_in_left_menu']) || $GLOBALS['enable_fees_in_left_menu'] == 1){ ?>
  <li class="treeview"><a href="#"><i class="fa fa-money" aria-hidden="true"></i>
<span><?php xl('Fees','e') ?></span><span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span></a>
    <ul class="treeview-menu">
      <?php genMiscLink('RBot','cod','2',xl('Fee Sheet'),'patient_file/encounter/load_form.php?formname=fee_sheet'); ?>
  ...
  <!--
   <li><a class="collapsed" id="feeimg" ><span><?php xl('E-Cash','e') ?></span></a>
    <ul>
      <?php // genMiscLink('RBot','cod','2',xl('Cash Handover'),'patient_file/encounter/load_form.php?formname=fee_sheet'); ?>
      <?php // genTreeLink('RBot','cod',xl('Daily Deposit')); ?>
	  <?php // genMiscLink('RBot','voc','0',xl('Funds Summary'),'reports/payment_voucher.php?framed=1'); ?> 
	  
    </ul>
  </li>
  -->
	<?php  if (acl_check('menus', 'modle')||acl_check('admin', 'super')) {?>
   <li class="treeview"><a href="#"><i class="fa fa-modx" aria-hidden="true"></i>
<span><?php echo xlt('Modules') ?></span><span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span></a>
    <ul class="treeview-menu">
	<?php genMiscLink('RTop','adm','0',xl('Manage Modules'),'modules/zend_modules/public/Installer'); ?>
	 <?php genMiscLink('RTop','rep','0',xl('test'),'reports/ecash.php');  ?>
...
<!-- <?php if ($GLOBALS['inhouse_pharmacy'] && acl_check('admin', 'drugs')) { ?>
  <li><a class="collapsed" id="phrimg" ><span><?php xl('Pharmacy','e') ?></span></a>
    <ul>
	  ...
	  <?php //genMiscLink('RTop','rep','0',xl('Pharmacy Bill'),'reports/custom_report_ins.php'); ?>
      <?php g//enPopLink(xl('Destroyed'),'destroyed_drugs_report.php'); ?>
    </ul>
  </li>
<?php } ?> -->
<?php
...
<span><?php xl('Pharmacy','e') ?></span><span class="pull-right-container">
  ...
  <?php } ?>
 <?php  $newcrop_user_role=sqlQuery("select newcrop_user_role from users where username='".$_SESSION['authUser']."'");
  if($newcrop_user_role['newcrop_user_role']=='erxlab'||acl_check('admin', 'super')){
  ?>
	
  <li class="treeview"><a href="#"><i class="fa fa-share"></i><span><?php xl('Procedures','e') ?></span><span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span></a>
    <ul class="treeview-menu">
				...
				if (sqlNumRows($module_query)) {
					...
					while ($modulerow = sqlFetchArray($module_query)) {
						...
						if($jid==0 || ($modid!=$modulerow['mod_id'])){
							...
							echo "</ul>";
						?>
						<li><a href="#"><span><?php echo xlt($modulerow['mod_ui_name']); ?></span><span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span></a>
							<ul class="treeview-menu">
						<?php
...
<?php if (acl_check('acct', 'rep_a')) { ?>
      <li><a href="#"><span><?php xl('Financial','e') ?></span><span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span></a>
        <ul class="treeview-menu">
...
<?php if (! $GLOBALS['simplified_demographics']) { ?>
      <li><a href="#"><span><?php xl('Insurance','e') ?></span><span class="pull-right-container">
        ...
        <ul class="treeview-menu">
		  ...
		  <?php genMiscLink('RTop','rep','0',xl('Revenue rep'),'reports/revenue_report.php'); ?>
...
<span><?php xl('Miscellaneous','e') ?></span><span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span></a>
    <ul class="treeview-menu">
