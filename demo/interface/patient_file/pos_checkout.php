...
<table cellpadding='5'>
 <tr>
  ...
  <td ><b><?php echo xlt('Item No'); ?></b></td>
...
<td><b><?php echo xlt('Payments')?></b></td>
<td><b><?php echo xlt('Receipt No.')?><b></td>
<td><b><?php echo xlt('Mode')?><b></td>
<td><b><?php echo xlt('Reference No.')?><b></td>
...
<form method='post' action='pos_checkout.php' onsubmit="return saveClicked();">
...
<table cellspacing='5'>
 <tr>
  <td colspan='3' align='center'>
   <b><?php echo xlt('Patient Discount for '); ?><?php echo text($patdata['fname']) . " " .
...
<table border='0' cellspacing='4'>
 ...
 <tr>
  ...
  <td>
   <input type='hidden' name='form_amount_no' size='10' value='0.00'>
  </td>
 </tr>
...
<tr>
 ...
 <tr>
  <td>
   <?php echo xlt('Discount By'); ?>:
  </td>
  <td><?php
                        // Build a drop-down list of providers.
                                //
                                $query = "SELECT title FROM list_options  WHERE ".
                                  "list_id ='Discount_Heads' "; 
                                $ures = sqlStatement($query);
                                echo "   <select name='reason_code'>\n";
                                while ($urow = sqlFetchArray($ures)) {
                                        $provid = $urow['title'];
