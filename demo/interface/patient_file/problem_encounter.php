...
<title><?php xl('Issues and Visits','e'); ?></title>
...
<table border='0' cellpadding='5' cellspacing='0' width='100%'>
 ...
 <tr>
  <td colspan='2' align='center'>
   <b><?php xl('Issues and Visits for','e'); ?> <?php echo $patdata['fname'] . " " . $patdata['lname'] . " ($pid)</b>\n"; ?>
  </td>
 </tr>
...
<?php if (!$GLOBALS['concurrent_layout']) { ?>
   <input type='button' value='<?php xl('Add Visit','e'); ?>' onclick='newEncounter()' />
<?php } ?>
