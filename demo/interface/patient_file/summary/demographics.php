...
<script type="text/javascript" language="JavaScript">
 ...
 function advdirconfigure() {
  ...
  function paynow()
{
	location.href='../front_payment.php';
	 <?php
	 $encounter=sqlStatement("SELECT encounter from form_encounter where pid=? ORDER BY encounter DESC LIMIT 1",array($pid));
...
$widgetLabel = "billing";
$widgetButtonLabel = xl("Pay now");
$widgetButtonLink = "return paynow()";
$widgetButtonClass = "";
