...
<body class="body_top">
	...
	?>
        <tr class="text">
            ...
            <td><input type="text" name="uname" value="<?php if($row['portal_username']) echo htmlspecialchars($row['portal_username'],ENT_QUOTES); else echo htmlspecialchars($row['genericname1'],ENT_QUOTES);?>" size="10" readonly></td>
        </tr>
        <tr class="text">
