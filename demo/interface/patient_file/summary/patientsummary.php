...
$path_to_this_script = $rootdir . "/patient_file/summary/patientsummary.php";
...
<p><i><h3><?php echo text($frow['name']) ?>
...
echo "<div id='labdata'>";
echo "<center><h2>" . xlt('Lab Results') . "</center></h2>";
...
if($printable) {
	...
	echo "<tr><td>" . xlt('Patient Visit ID') . ": </td><td>" . text($result['theencounter']) . "</td></tr>";
	echo "<tr><td>" . xlt('Procedure') . ": </td><td>" .  text($result['theprocedure']) . "</td></tr>";
