...
if (($_POST['form_save'] || $_POST['form_delete']) && !$alertmsg) {
  ...
  if ($drug_id) {
   ...
   $new_drug = true;
    ...
    "name,mfr,inStock,supplier,batch,quantity,free,pack,expdate,mrp,tradePrice,discount,vat,totalValue,invoice,max_level, form, " .
...
<td>
 ...
 <tr>
  ...
  <td>
   <input type='text' size='10' name='invoice' value="" maxlength='80' style='width:100%' placeholder="" required/>
  </td>
 </tr>
 ...
 <tr>
  ...
  <th nowrap><?php echo xlt('Medicine Name'); ?></th>
   <th nowrap><?php echo xlt('Manufacturer'); ?></th>
    <th nowrap><?php echo xlt('In Stock'); ?></th>
   <th  nowrap><?php echo xlt(' Batch Number'); ?></th>
  <th  nowrap><?php echo xlt('Quantity'); ?></th>
  <th  nowrap><?php echo xlt('Free'); ?></th>
  <th  nowrap><?php echo xlt('Pack'); ?></th>
  <th  nowrap><?php echo xlt('Expiry Date'); ?></th>
   <th  nowrap><?php echo xlt('M.R.P.'); ?></th>
   <th  nowrap><?php echo xlt('Trade Price'); ?></th>
   <th  nowrap><?php echo xlt('Discount'); ?></th>
...
?> 
 ...
 <tr>
  ...
  <td>
   <input type='text' size='10' name='instock[]' maxlength='80' value='' class="rgt" style='width:100%' />
  </td>
  ...
  <td>
   <input type='text' size='10' name='qty[]' maxlength='80' value='' class="rgt" style='width:100%' />
  </td>
  
  
  <td>
   <input type='text' size='10' name='free[]' maxlength='80' value='' class="rgt" style='width:100%' pattern="\d{1,9}" />
  </td>
  
  <td>
   <input type='text' size='20' name='pack[]' maxlength='80'  class="rgt" style='width:100%' />
  </td>
  
  <td>
   <input type="text" size='12' name="date[]" value="" class="datepicker-example11" />
  </td>
  
  <td>
  <input type='text' size='20' name='mrp[]' maxlength='80' value='' class="rgt" style='width:100%' />
  </td>
  
  <td>
  <input type='text' size='20' name='trade[]' maxlength='80' value='' class="rgt" style='width:100%' />
  </td>
  
  <td>
  <input type='text' size='10' name='discount[]' maxlength='80' value='' class="rgt" style='width:100%'  />
  </td>
 ...
 <select name="vat[]">
  ...
  <td>
  <input type='text' size='10' name='total[]' maxlength='80' value='' class="rgt" style='width:100%' />
  </td>
