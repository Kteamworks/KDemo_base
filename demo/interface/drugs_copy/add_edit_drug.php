...
if (($_POST['form_save'] || $_POST['form_delete']) && !$alertmsg) {
  ...
  if ($drug_id) {
   ...
   $new_drug = true;
    ...
    "name,mfr,inStock,supplier,batch,quantity,free,pack,packType,expdate,mrp,tradePrice,discount,vat,totalValue,invoice,max_level, form, " .
...
?> 
 ...
 <tr>
  ...
  <td>
   <input type='text' size="10" name='pack[]' maxlength='80'  class="rgt" style='width:100%'  pattern="\d*" placeholder="interger" />
  </td>
 ...
 <select name="type[]">
  ...
  <td>
  <input type='text' size="10" name='mrp[]' maxlength='80' value='' class="rgt" style='width:100%' pattern="\d+(\.\d{2})" placeholder="00.00"/>
  </td>
  
  <td>
  <input type='text' size="10" name='trade[]' maxlength='80' value='' class="rgt" style='width:100%' pattern="\d+(\.\d{2})" placeholder="00.00" />
   
  </td>
  
  <td>
  <input type='text' size="10" name='discount[]' maxlength='80' value='' class="rgt" style='width:100%' pattern="\d+(\.\d{2})%" placeholder="00.00%"  />
  </td>
 ...
 <select name="vat[]">
  ...
  <td>
  <input type='number' size='10' name='total[]' maxlength='80' value='' class="rgt" style='width:100%' pattern="\d+(\.\d{2})" placeholder="00.00" />
  </td>
