...
if (isset($_POST['submit'])) {
	...
	/*$list = sqlStatement("SELECT b.date,b.fee, b.pid, b.encounter, b.code_type, b.code, b.units,
		...
		*/
		$list = sqlStatement("select date,pid,substring(encounter_ipop,1,2) as cat,encounter from form_encounter fe 
         
          where date>='$from 00:00:00' and date<='$to 23:59:59'");
...
<form method="post" action="">
  ...
  <td>
                        <input type='text' name='' value='<?php echo $list1['cat'];   ?>' style="height:2em;border:1px solid white;" readonly>
 </td>
 
  <td>
                        <input type='text' name='cat[]' value='<?php echo $list1['encounter'];   ?>' style="height:2em;border:1px solid white;" readonly>
 </td>
