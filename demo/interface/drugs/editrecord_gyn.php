...
$fetch_query= "update form_vitals set date='$date',complaint='$complaints',pa='$pa',pv='$pv',ps='$ps',note='$exam',Treatmentadvise='$advise' where id='$id'";
...
<table width="100" align="center" cellspacing="0" cellpadding="3" border="1"> 
  ...
  <tr>
    <th>Complaints</th>
    <td><textarea name='complaint' rows="2" cols="25" style="border:1px solid white;background-color:#DCDCDC;"><?php echo $info['complaint'] ?></textarea></td>
  </tr>
  <!--
  <tr>
    <th>Hb % Urine RE</th>
  ...
  <tr>
    <th>P.V.</th>
    <td><input type="text" name="pv" value="<?php echo $info['pv']; ?>" /></td>
  </tr>
  <tr>
    <th>P.S.</th>
    <td><input type="text" name='ps' value="<?php echo $info['ps']; ?>" ></td>
  </tr>  
  <tr>
    <th>Examination Findings</th>
    <td><textarea name='exam' rows="2" cols="25" style="border:1px solid white;background-color:#DCDCDC;"><?php echo $info['note'] ?></textarea></td>
  </tr>
   <tr>
    <th>Treatment & Advise</th>
    <td><textarea name='advise' rows="2" cols="25" style="border:1px solid white;background-color:#DCDCDC;" ><?php echo $info['Treatmentadvise'] ?></textarea></td>
