...
$mens_cycle     = (isset($_POST['mens_cycle'])) ? $_POST['mens_cycle'] : '';
...
if ($mode == 'new')
{
  ...
  sqlInsert("INSERT INTO form_encounter SET " .
      ...
      //"age = '" . add_escape_custom($age) . "', " .
      //"occu = '" . add_escape_custom($occu) . "', " .
      //"hus = '" . add_escape_custom($hus) . "', " .
      //"ml = '" . add_escape_custom($ml) . "', " .
      "cons = '" . add_escape_custom($cons) . "', " .
      "lmp = '" . add_escape_custom($lmp) . "', " .
      "edd = '" . add_escape_custom($edd) . "', " .
      "gravida = '" . add_escape_custom($gravida) . "', " .
      ...
      "referral_source = '" . add_escape_custom($referral_source) . "', " .
	   "encounter = '" . add_escape_custom($encounter) . "', " .
	    "visittype = '" . add_escape_custom($visittype) . "', " .
      "pid = '" . add_escape_custom($pid) . "', " .
      "para = '" . add_escape_custom($para) . "', " .
	  "mens_cycle = '" . add_escape_custom($mens_cycle) . "'"),
	...
	if($dayy=="Wednesday"&&($time>='08:00:00'&& $time<='22:59:59'))
	{
	if(!($pc_catid==5 || $pc_catid==12 || $pc_catid==16 || $pc_catid==17|| $pc_catid==13))
	{
