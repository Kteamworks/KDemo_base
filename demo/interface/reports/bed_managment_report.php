...
<span class='title'><?php xl('Report','e'); ?> - <?php xl('IN Patients','e'); ?></span>
  ...
  <td width='410px'>
	...
	<table class='text'>
		<tr>
			...
			<td>
			   <input type='text' name='form_from_date' id="form_from_date" size='10' value='<?php echo date('Y-m-01') ?>'
			...
			<td>
			   <input type='text' name='form_to_date' id="form_to_date" size='10' value='<?php echo date('Y-m-d') ?>'
				onkeyup='datekeyup(this,mypcc)' onblur='dateblur(this,mypcc)' title='yyyy-mm-dd'>
			   <img src='../pic/show_calendar.gif' align='absbottom' width='24' height='22'
