...
<form name='theform' id='theform' method='post' action='prescription_email_report.php'>
...
<?php
 ...
 // if ($form_patient_id) $where .= " AND p.pubpid = '$form_patient_id'";
  ...
  $query = "SELECT r.id, r.patient_id, " .
   ...
   "ORDER BY p.fname, p.lname, p.pubpid, r.id, s.sale_id";
  ...
  while ($row = sqlFetchArray($res)) {
   ...
   $patient_name    = $row['fname'] . '  ' . $row['lname'] . ' ' . $row['mname'];
...
?>
 ...
 <?php
    ...
    $message.='<tr bgcolor="#ddddff"><td class="detail">'. htmlspecialchars($patient_name).'</td>'.'<td class="detail">'.htmlspecialchars($patient_id).'</td><td class="detail">'. htmlspecialchars($prescription_id).'</td> <td class="detail" align="right">'.		  htmlspecialchars($drug_name).'</td><td class="detail">'.htmlspecialchars($ndc_number).'</td><td class="detail">'.htmlspecialchars($drug_units).'</td><td class="detail">'.htmlspecialchars($refills).'</td><td class="detail">'.htmlspecialchars($instructed).'</td><td class="detail">'.htmlspecialchars($reactions).'</td><td class="detail">'.htmlspecialchars($row['quantity']); 
		  '</td></tr>';
?>
<?php
