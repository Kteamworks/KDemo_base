...
<form name='new_head' method='post' action="new_head_save.php"
...
<table border='0'>
 ...
 <tr>
  <td>
   <span class='bold'><?php xl('Head Name','e');?>: </span>
  </td>
  <td></td>
  <td>
 ...
 <tr>
  <td colspan='2'>
   &nbsp;<br>
   <input type='submit' name='form_create' value=<?php xl('Create New Head','e'); ?> />
  </td>
  <td>
  </td>
 </tr>
