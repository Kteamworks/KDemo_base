...
$rateplan=$patdata['rateplan'];
	 ...
	 */echo "</table>";
        ...
        if (count($patient) > 0) {
			...
			echo "<td class='bold' width='10%'>".xlt('Batch/Exp Date')."</td>";
			echo "<td class='bold' width='10%'>".xlt('Ord Doc.')."</td>";
            ...
            echo "<td class='bold' width='10%' align='right'>".xlt('Amount')."</td></tr><tr style='border-bottom: 1px solid #000;'><td></td><td></td><td></td><td></td><td></td><td></td></tr>";
			echo "</b>";
