...
$totalins=0;
  while ($row = sqlFetchArray($res)) {
	...
	if($plan!='-- No Insurance --')
	{
		$totalins+=$row['charges'];
	}
  }
  $ist=$insarr[$plan]['charges'];
  ksort($insarr);
  $total=0;
...
<?php
 ...
 <td align='left' colspan=1>Insurance Total: </td> <td align='right'><?php echo oeFormatMoney($totalins); ?></td><td></td><td></td><td></td>
 </tr>
  <tr class='report_totals'>
 
 <td align='left' colspan=1>Total: </td> <td align='right'><?php echo oeFormatMoney($total); ?></td><td></td><td></td><td></td>
 </tr><?php
} // end if
