...
//
$ORDERHASH = array(
  'doctor'  => 'lower(u.fname), lower(u.lname), fe.date',
  'patient' => 'lower(p.fname), lower(p.lname), fe.date',
  'pubpid'  => 'lower(p.pubpid), fe.date',
  'time'    => 'fe.date, lower(u.fname), lower(u.lname)',
);
