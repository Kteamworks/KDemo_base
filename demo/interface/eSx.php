...
if($pid)
{
    ...
    if($GLOBALS['erx_upload_active']==1)
        $active = 'and active=1';    
    $res_presc=sqlStatement("select id from prescriptions where type= 's' and patient_id=? and erx_source='0' and erx_uploaded='0' $active limit 0,".$GLOBALS['total_count'],array($pid));
