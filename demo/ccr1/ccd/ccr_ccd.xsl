...
xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="a date">
    ...
    <xsl:import href="./templates/datetime.xsl"/>
	 <xsl:import href="./templates/datetime1.xsl"/>
    ...
    <xsl:template match="/">
        <ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:voc="urn:hl7-org:v3/voc" xmlns:sdtc="urn:hl7-org:sdtc"  xsi:schemaLocation="urn:hl7-org:v3 http://xreg2.nist.gov:8080/hitspValidation/schema/cdar2c32/infrastructure/cda/C32_CDA.xsd" classCode="DOCCLIN" moodCode="EVN">
            ...
            <title><xsl:value-of select="/a:ContinuityOfCareRecord/a:Actors/a:Actor[a:ActorObjectID=$ccrFromActorObjectID]/a:Organization/a:Name"/></title>
            <effectiveTime>
       ...
       `             <effectiveTime>
            ...
            <component>
                <structuredBody>
                        ...
                        <component>
                            <section>
							  ...
							  <templateId root="1.3.6.1.4.1.19376.1.5.3.1.3.13" />
                                <code code="48765-2" displayName="Admissions, Discharge and Diagnosis" codeSystem="2.16.840.1.113883.6.1" codeSystemName="LOINC" />
                                ...
                                <text>
                                    <table>
                                        <tbody>
                                            ...
                                            <xsl:for-each select="/a:ContinuityOfCareRecord/a:Body/a:Admissions/a:Admission">
                                                <tr>
                                                   ...
                                                   <td align= "center">
													...
													<td align= "center">
                                                        <table>
                                                            <tbody>
                                                                <xsl:apply-templates select="a:DateTime1"/>
                                                            </tbody>
                                                        </table>
                                                    </td> 
                                                    ...
                                                    <td align= "center">
                                                        <xsl:value-of select="a:Diagnosis/a:Text"/>
                                                    </td>
                                                    <td align= "center">
                                                        <xsl:value-of select="a:Consultant/a:Text"/>
                                                    </td>
                                    ...
                                    <table>
                                        <tbody>
                                            ...
                                            <xsl:for-each select="/a:ContinuityOfCareRecord/a:Body/a:Problems/a:Problem">
                                                <tr>
                                                      <th align="left" style="width:120px;">History</th>
                                                    <td>
														<xsl:attribute name="ID">
								...
								<text>
                                    <table>
                                        <tbody>
                                            ...
                                            <xsl:for-each select="/a:ContinuityOfCareRecord/a:Body/a:Problems/a:Problem">
                                                <tr>
                                                    <th align="left" style="width:120px;">Obstetric History</th>
                                                    <td>
														<xsl:attribute name="ID">
															<xsl:value-of select="a:CCRDataObjectID"></xsl:value-of>
														</xsl:attribute>
                                                        <xsl:value-of select="a:ObstetricDesc/a:Text"/>
                                                    </td>
								...
								<text>
                                    <table>
                                        <tbody>
                                            ...
                                            <xsl:for-each select="/a:ContinuityOfCareRecord/a:Body/a:Problems/a:Problem">
                                                <tr>
                                                    <th align="left" style="width:120px;">Past History</th>
                                                    <td>
														<xsl:attribute name="ID">
															<xsl:value-of select="a:CCRDataObjectID"></xsl:value-of>
														</xsl:attribute>
                                                        <xsl:value-of select="a:PastDesc/a:Text"/>
                                                    </td>
								...
								<text>
                                    <table>
                                        <tbody>
                                            ...
                                            <xsl:for-each select="/a:ContinuityOfCareRecord/a:Body/a:Problems/a:Problem">
                                                <tr>
                                                    <th align="left" style="width:120px;">Family History</th>
                                                    <td>
														<xsl:attribute name="ID">
															<xsl:value-of select="a:CCRDataObjectID"></xsl:value-of>
														</xsl:attribute>
                                                        <xsl:value-of select="a:FamilyDesc/a:Text"/>
                                                    </td>
								...
								<text>
                                    <table>
                                        <tbody>
                                            ...
                                            <xsl:for-each select="/a:ContinuityOfCareRecord/a:Body/a:Problems/a:Problem">
                                                <tr>
                                                     <th align="left" style="width:120px;">On Examination</th>
                                                    <td>
														<xsl:attribute name="ID">
															<xsl:value-of select="a:CCRDataObjectID"></xsl:value-of>
														</xsl:attribute>
                                                        <xsl:value-of select="a:OnExam/a:Text"/>
                                                    </td>
								...
								<text>
                                    <table>
                                        <tbody>
                                            ...
                                            <xsl:for-each select="/a:ContinuityOfCareRecord/a:Body/a:Problems/a:Problem">
                                                <tr>
                                                     <th align="left" style="width:120px;">Pre Abdomen</th>
                                                    <td>
														<xsl:attribute name="ID">
															<xsl:value-of select="a:CCRDataObjectID"></xsl:value-of>
														</xsl:attribute>
                                                        <xsl:value-of select="a:PreAbdomen/a:Text"/>
                                                    </td>
								...
								<text>
                                    <table>
                                        <tbody>
                                            ...
                                            <xsl:for-each select="/a:ContinuityOfCareRecord/a:Body/a:Problems/a:Problem">
                                                <tr>
												     <th align="left" style="width:120px;">Surgery</th>
                                                    
                                                    <td>
														<xsl:attribute name="ID">
															<xsl:value-of select="a:CCRDataObjectID"></xsl:value-of>
														</xsl:attribute>
                                                        <xsl:value-of select="a:Surgery/a:Text"/>
                                                    </td>
                                        ...
                                        <tbody>
                                            ...
                                            <xsl:for-each select="/a:ContinuityOfCareRecord/a:Body/a:Problems/a:Problem">
                                                <tr>
                                                    ...
                                                    <th align="left" style="width:120px;">OT Notes</th>
                                                    <td>
													
														<xsl:attribute name="ID">
															<xsl:value-of select="a:CCRDataObjectID"></xsl:value-of>
														</xsl:attribute>
                                                        <xsl:value-of select="a:OtNotes/a:Text"/>
                                                    </td>
                                        ...
                                        <tbody>
                                            ...
                                            <xsl:for-each select="/a:ContinuityOfCareRecord/a:Body/a:Problems/a:Problem">
                                                <tr>
                                                    ...
                                                    <th align="left" style="width:120px;">Findings</th>
                                                    <td>
													
														<xsl:attribute name="ID">
															<xsl:value-of select="a:CCRDataObjectID"></xsl:value-of>
														</xsl:attribute>
                                                        <xsl:value-of select="a:Findings/a:Text"/>
                                                    </td>
                                        ...
                                        <tbody>
                                            ...
                                            <xsl:for-each select="/a:ContinuityOfCareRecord/a:Body/a:Problems/a:Problem">
                                                <tr>
                                                    ...
                                                    <th align="left" style="width:120px;">Urine Output</th>
                                                    <td>
													
														<xsl:attribute name="ID">
															<xsl:value-of select="a:CCRDataObjectID"></xsl:value-of>
														</xsl:attribute>
                                                        <xsl:value-of select="a:UrineOP/a:Text"/>
                                                    </td>
                                        ...
                                        <tbody>
                                            ...
                                            <xsl:for-each select="/a:ContinuityOfCareRecord/a:Body/a:Problems/a:Problem">
                                                <tr>
                                                    ...
                                                    <th align="left" style="width:120px;">Treatment Given</th>
                                                    <td>
													
														<xsl:attribute name="ID">
															<xsl:value-of select="a:CCRDataObjectID"></xsl:value-of>
														</xsl:attribute>
                                                        <xsl:value-of select="a:TreatmentGvn/a:Text"/>
                                                    </td>
                                        ...
                                        <tbody>
                                            ...
                                            <xsl:for-each select="/a:ContinuityOfCareRecord/a:Body/a:Problems/a:Problem">
                                                <tr>
                                                    ...
                                                    <th align="left" style="width:120px;">Course in the Hospital</th>
                                                    <td>
													
														<xsl:attribute name="ID">
															<xsl:value-of select="a:CCRDataObjectID"></xsl:value-of>
														</xsl:attribute>
                                                        <xsl:value-of select="a:CIH/a:Text"/>
                                                    </td>
					...
					<xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Medications">
                        <component>
                            <section>
                                ...
                                <title>Advice On Discharge</title>
                                <text>
                                    <table>
                                        <tbody>
                                            <tr>
					...
					<xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Clinicals">
                        <component>
                            <section>
							  <templateId root="2.16.840.1.113883.10.20.1.2" />
							  <!--C83 Allergies and Other Adverse Reactions Section Conformance Identifier-->
							  ...
							  <!--IHE Allergies and Other Adverse Reactions Section Conformance Identifier-->
							  <templateId root="1.3.6.1.4.1.19376.1.5.3.1.3.13" />
                                <code code="48765-2" displayName="Clinical Information" codeSystem="2.16.840.1.113883.6.1" codeSystemName="LOINC" />
                                
                                <text>
                                    <table>
                                        <tbody>
                                           <!--  <tr>
                                                <th align="left">Advice On Discharge</th>
                                            </tr> 
											<xsl:for-each select="/a:ContinuityOfCareRecord/a:Body/a:Clinicals/a:Clinical">
											<tr> 
											    
                                             <td>  <xsl:value-of select="a:AOD/a:Text"/>   </td>
                                             </tr>
											 </xsl:for-each>-->
											  ...
											  <tr>	
											 <th align="left">Condition on Discharge</th>
                                            </tr>
										 <xsl:for-each select="/a:ContinuityOfCareRecord/a:Body/a:Clinicals/a:Clinical">
                                            <tr>
                                                    <td>    <xsl:value-of select="a:COD/a:Text"/>
                                                    </td>
											</tr>
                                             </xsl:for-each>
											 <tr>
										 ...
										 <xsl:for-each select="/a:ContinuityOfCareRecord/a:Body/a:Clinicals/a:Clinical">
                                            <tr>
                                                    <td>    <xsl:value-of select="a:FLP/a:Text"/>
                                                    </td>
											</tr>
                                             </xsl:for-each>
                                        </tbody>
                                        ...
                                        <tbody>
                                            ...
                                            <xsl:for-each select="/a:ContinuityOfCareRecord/a:Body/a:Results/a:Result">
                                                <tr>
													...
													<xsl:value-of select="a:TestCode/a:Text"/>
													 </xsl:for-each>
                                                    </td>
                                                    <td>
													 <xsl:apply-templates select="a:DateTime"/>
													  ...
													  <td>
                                                        <xsl:for-each select="a:Test[a:TestResult/a:Value!='']">
                                                            <div>
                                                                ...
                                                                <xsl:value-of select="a:Range/a:Text"/>
