...
do {
  ...
  $e_Actor->appendChild($e_ActorID);
   ...
   $date = date_create($row['date']);
    ...
    $e_TestCode = $ccr->createElement('TestCode');
	$e_Test->appendChild($e_TestCode);

	$e_Text = $ccr->createElement('Text', $row['procedure_name']);
	$e_TestCode->appendChild($e_Text);
	
	  $e_Range = $ccr->createElement('Range');
	$e_Test->appendChild($e_Range);

	$e_Text = $ccr->createElement('Text', $row['range']);
	$e_Range->appendChild($e_Text);
