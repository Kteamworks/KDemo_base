...
class PasswordController extends Controller
{
   ...
   // $mail->MsgHTML("<html><body><div class='wrapper'>".$logo."&nbsp;".$message."</div></body></html>");
    $mail->MsgHTML("<html><body><div class='wrapper'><p>Click on the url below to reset your password.<br> <a href='http://".$_SERVER["HTTP_NAME"]."".$GLOBALS['webroot']."/interface/reset/reset.php?token=".$code."'></a></p></div></body></html>");
    $mail->IsHTML(true);
