...
class PasswordController extends Controller
{
   ...
   // $mail->MsgHTML("<html><body><div class='wrapper'>".$logo."&nbsp;".$message."</div></body></html>");
    $mail->MsgHTML("<html><body><div class='wrapper'><p>Click on the url below to reset your password.<br> http://localhost/KDemo_base/demo/interface/reset/reset.php?".$code."</p></div></body></html>");
    $mail->IsHTML(true);
